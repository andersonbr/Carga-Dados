...
public class CargaOperacoesAntiga extends Operacao {
    public CargaOperacoesAntiga(String in, String out) {
        openIn(in);
        openOut(out);
    }
    public void start() {
        String line = null;
        writeOutLine("CREATE TABLE carga_zetra_antigo ("+
        ...
        for (int lineNumber = 0; (( line = readInLine()) != null);lineNumber++ ) {
			...
			String output = "INSERT INTO carga_zetra_antigo (status, " +
    ...
    public static void main(String[] args) {
        Operacao op = new CargaOperacoesAntiga(
            "/home/anderson/Sistemas/MargemGuarulhos/ML004E.txt",
            "/home/anderson/Sistemas/MargemGuarulhos/ML004E.txt.sql"
        );
        op.start();
    }
}